...
void PageSelector::setPageNavigation(QPdfPageNavigator *pageNavigation)
{
    m_pageNavigation = pageNavigation;

    connect(m_previousPageButton, &QToolButton::clicked, m_pageNavigation, &QPdfPageNavigator::goToPreviousPage);
    connect(m_pageNavigation, &QPdfPageNavigator::canGoToPreviousPageChanged, m_previousPageButton, &QToolButton::setEnabled);

    connect(m_pageNavigation, &QPdfPageNavigator::currentPageChanged, this, &PageSelector::onCurrentPageChanged);
    connect(m_pageNavigation, &QPdfPageNavigator::pageCountChanged, this, [this](int pageCount){
    ...
    connect(m_nextPageButton, &QToolButton::clicked, m_pageNavigation, &QPdfPageNavigator::goToNextPage);
    connect(m_pageNavigation, &QPdfPageNavigator::canGoToNextPageChanged, m_nextPageButton, &QToolButton::setEnabled);
